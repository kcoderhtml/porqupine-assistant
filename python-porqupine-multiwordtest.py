...
def doaction(keyword):
	#os.system('ls')
	if keyword == 'jarvis':
		os.system('espeak \'Number 1 Wake word Detected. Lock Down Commenced.\' & dbus-send --type=method_call --dest=org.gnome.ScreenSaver \
    /org/gnome/ScreenSaver org.gnome.ScreenSaver.Lock')
	elif keyword == 'blueberry':
		os.system('espeak \'Blueberry Initizilation Started. Operation BerryBlue commenced.\' &&')
